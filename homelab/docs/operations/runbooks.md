...
> - **Step 3 (rebuild Tailscale CT 110 on oneill) was skipped** — CT 110 was instead migrated to carter then back to apophis. Moving it to oneill per ADR-009 placement remains a deferred follow-up.
