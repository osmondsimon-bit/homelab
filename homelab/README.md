...
This file has been superseded to avoid documentation drift. Current, authoritative
information lives in:

- **[PLAN.md](PLAN.md)** — single source of truth: current infrastructure (hosts, IPs,
