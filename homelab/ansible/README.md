...
| `provision-apophis-recovery-monitor.yml` | Temporary read-only post-recovery monitor on apophis — immediate commissioning check plus fixed 09:00 AEST runs on 2026-07-24/25/26; checks ZFS/NVMe/kernel recurrence, replication, and the 3 GiB memory guardrail; ntfy reports every result |
