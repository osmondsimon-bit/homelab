...
| `provision-actual.yml` | Actual Budget VM 127 on Carter — pinned official container, loopback-only app port, Tailscale Serve HTTPS, persistent data (ADR-023). Prompts for a tagged Tailscale auth key |
