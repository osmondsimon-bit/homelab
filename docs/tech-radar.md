...
| DNS + ad blocking | Technitium DNS | Phase 2 — deployed on **oneill** (NUC), CT 111. DNS-only, UniFi keeps DHCP (ADR-011); OISD Big + DoH, config automated via API. **DHCP cutover pending.** |
